...
- `.github/workflows/kepenk-policy.yml`: CI verification using the pinned public `v0.2.1` Kepenk GitHub Action.
...
The `v0.2.1` release is used because it supports repositories without Python dependency files. This npm/Turborepo pilot reproduces that portability requirement directly.
